...
class ICocheRepository(ABC):
    """
    Interfaz que define las operaciones del repositorio de coches.
    """
    
    @abstractmethod
    def find_by_dni(self, matricula: str) -> Optional[Coche]:
        """Busca un coche por su matrícula."""
        pass
    
    @abstractmethod
    def add(self, coche: Coche) -> None:
        """Añade un nuevo coche al repositorio."""
        pass
